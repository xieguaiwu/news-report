...
## Corpus Check
- 46 files · ~29,032 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 427 nodes · 836 edges · 25 communities (20 shown, 5 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 102 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7c8a34e8`
...
### Community 1 - "Config"
Cohesion: 0.13
Nodes (30): Config, SourceOverride, Default(), expandPath(), Duration, Load(), boolPtr(), T (+22 more)
...
### Community 16 - "Model"
Cohesion: 0.12
Nodes (22): Builder, Category, catColorIcon(), fetchReaderCmd(), fetchReportCmd(), Cmd, Context, Item (+14 more)
...
## Knowledge Gaps
- **63 isolated node(s):** `news-report`, `keywordSet`, `readerMsg`, `saveMsg`, `Acceptance Contract` (+58 more)
...
- **Why does `Run()` connect `Run` to `Fetcher`, `Config`, `Classify`, `Defaults`, `Score`, `IsDuplicate`, `Model`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `Parse()` connect `Parse` to `Fetcher`, `Config`, `Run`, `Extract`, `Extract`, `Search`?**
